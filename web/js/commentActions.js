/**
 * Created by tharwat on 5/25/2019.
 */
function postComment(button, postedBy, videoId, replyTo, containerClass) {
    ...
    if(commentText) {
        ...
        $.post("../ajax/postComment.php", { commentText: commentText, videoId: videoId, responseTo: replyTo })
    ...
    $.post("../ajax/likeComment.php", { commentId: commentId })
        .done(function(numToChange) {
            ...
            if(numToChange < 0) {
                ...
                likeButton.find("img:first").attr("src", "../web/images/icons/thumb-up.png");
            }
            else {
                likeButton.find("img:first").attr("src", "../web/images/icons/thumb-up-active.png")
            }

            dislikeButton.find("img:first").attr("src", "../web/images/icons/thumb-down.png");
        });
}
    ...
    $.post("../ajax/dislikeComment.php", { commentId: commentId })
        .done(function(numToChange) {
            ...
            if(numToChange > 0) {
                ...
                dislikeButton.find("img:first").attr("src", "../web/images/icons/thumb-down-active.png")
            }
